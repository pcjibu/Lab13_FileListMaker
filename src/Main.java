...
public class Main
{
        ...
        do {
            ...
            switch (ans) {
                ...
                case "V":
                    ...
                    break;
                case "Q":
                    if (SafeInput.getYNConfirm(in, "Do you want to save before you quit?")) {
                        if (needsToBeSaved) {
                            saveCurrentFile(arrList, fileName);
                        }
                        run = false;
    ...
    public static void addToList(Scanner in, ArrayList arrList) {
        String itemToAdd = SafeInput.getNonZeroLenString(in, "What would you like to add to the list? ");
